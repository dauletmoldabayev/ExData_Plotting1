...
# setting a 2-by-2 layout for the plot
par(mfcol = c(2,2))
##              First plot
# plotting the data omitting x-axis label and ticks
plot(newdata$Global_active_power, xaxt = "n", type = 'l', xlab = '', 
...
##              Third plot
plot(newdata$Voltage, xaxt = "n", xlab = 'datetime', type = 'l', 
                                                ylab = 'Voltage')
# specifying ticks for x-axis
ticks = c('Thu', 'Fri', 'Sat')
# specifying positions for ticks
...
##              Fourth plot
plot(newdata$Global_reactive_power, xaxt = "n", xlab = 'datetime', type = 'l', 
